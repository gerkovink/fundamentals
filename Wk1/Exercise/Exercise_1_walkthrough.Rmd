...
You can find [`markdown.Rmd` here](markdown.Rmd).

Have a look at the code in the markdown file and make sure that you understand what is going on. If you do not understand what you are looking at, please ask me (Gerko) during the lecture or [via e-mail](mailto:G.Vink@uu.nl), or ask the workgroup instructor. 
