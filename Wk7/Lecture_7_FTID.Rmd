...
The `Pclass` column is now correctly coded as a factor.
...
## Interactions
An interaction occurs when the (causal) effect of one predictor depends on the level of the (causal) effect of another predictor.
