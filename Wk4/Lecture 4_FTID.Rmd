...
Last week we started with linear modeling, but time did not permit us to finish the lecture. Today we start with the leftover part of last-week's lecture. 
...
The components in linear modeling
...
Plot predicted `y1`  against observed `y1`. This is a useful technique to investigate linearity for models with multiple predictors.

## Violation of linearity {.smaller}
```{r fig.height=3, dev.args = list(bg = 'transparent')}
