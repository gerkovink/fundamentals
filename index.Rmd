...
This dashboard covers the course materials for the course [***Fundamental Techniques in Data Science with R***](https://osiris.uu.nl/osiris_student_uuprd/OnderwijsCatalogusSelect.do?selectie=cursus&cursus=201900026&collegejaar=2019&taal=en)

---

Course leader: [Gerko Vink](https://www.gerkovink.com) <br>
Workgroup instructor: [Justin Kraaijenbrink](https://www.uu.nl/medewerkers/JTKraaijenbrink) <br>
...
Hand in a markdown compiled `html` file for exercise 3 to the [SurfDrive](https://surfdrive.surf.nl/files/index.php/s/yx5SsHz3haHLhqK) drop folder. Name the file `Yourname.Rmd`, where `Yourname` is your name. Do this ***before the next lecture on Monday***. 
