...
### `R` exercise
This week's `R` exercise can be found [here](nolinkyet)

Make the exercise and submit the resulted exercise file to the [SurfDrive](https://surfdrive.surf.nl/files/index.php/s/yx5SsHz3haHLhqK) drop folder. Do this ***before the next lecture on Monday***. 
