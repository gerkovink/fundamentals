...
- Make [Exercise 3](Wk1/Exercise/Exercise_3_walkthrough.html) before the next lecture.

A video discussion of the exercises will be available from this window after the second lecture.  

Hand in the `R-script` and the `RData` file for exercise 3 to the [SurfDrive](https://surfdrive.surf.nl/files/index.php/s/yx5SsHz3haHLhqK) drop folder. Do this ***before the next lecture on Monday***. 
